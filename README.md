...
- **SMB 부호 반전: 월 -0.67%(t=-2.57)**, 미국(+0.29%)과 반대. 소형주가 대형주를 이기지 못하는 구조
...
25개 포트폴리오 3-Factor 회귀 평균 R²는 0.72(0.40~0.88). 시장 베타는 모두 1 부근에 분포하고, HML 베타는 BM 분위가 높을수록 0.59~1.13으로 단조 증가한다. 포트폴리오가 팩터 노출을 제대로 포착했다는 뜻이다.

## SMB 부호 반전, 왜 일어났나

미국에서 규모 효과(Small Minus Big)는 양(+)이지만 한국은 반대다. 분석 기간 내내 소형주보다 대형주가 나은 성과를 냈다.
