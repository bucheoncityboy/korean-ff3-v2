...
> **요약**: 본 연구는 Fama-French(1993) 3-Factor 모델을 한국 시장에 맞게 전면 재구축한 것입니다. KOSPI 및 KOSDAQ 1,054개 종목을 대상으로 2000년 7월부터 2026년 5월까지의 월간 데이터를 사용하여 시장초과수익률(Mkt-RF), 규모(SMB), 가치(HML) 팩터를 추정하였습니다. 가치가중(VW) 포트폴리오 구성, 한국종합채권Monkey 금리 기반 무위험수익률, 금융업 명칭 기준 제외 등의 방법론적 개선을 적용하였으며, GRS 검정 결과(F=1.697, p=0.023)를 통해 모델의 설명력과 한계를 체계적으로 분석하였습니다.
...
| **무위험수익률** | 한국은행 한국종합채권Monkey 금리 (월별) |
...
5. **무위험수익률의 근사**: 한국종합채권Monkey 금리를 무위험수익률 대리변수로 사용하였으나, 이는 기간 선물 금리에서 추출된 근사치입니다.
